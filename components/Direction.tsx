    ...
    <section className="section direction">
      <div className="container direction-layout">
        ...
        <div className="direction-copy">
          <span className="section-kicker">04 — OUR DIRECTION</span>
          <h2>하나의 서비스가 아닌,<br /><em>계속되는 문제 해결</em></h2>
          <p>우리는 하나의 성공 방식에 머무르지 않습니다. 사용자에게 필요한 문제를 발견하고, 가장 적합한 기술과 방식으로 새로운 서비스를 만들어갑니다.</p>
          <div className="direction-note"><span>✦</span><p><b>Technology as a tool</b>AI와 자동화는 목적이 아니라, 더 나은 문제 해결을 위한 가장 유용한 수단입니다.</p></div>
        </div>
      </div>
    </section>
  );
